...
export default class WiseSquareProps extends Component {
  static defaultProps = {
    messages: [
  ...
  // dispenseWisdom () {           // will generate <Cannot read property 'props' of undefined>
  ...
  render() {
    return (
      <div className="WiseSquareProps" onMouseEnter={this.dispenseWisdom}>
        😍
      </div>
    );
  }
